    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                date_yy.addEventListener('mousedown', function(event1) {
                    var e = event1 || window.event1;
                    document.onmousemove = function(event) {
                        gearTouchMove.call(date_yy,event)
                    }
                    gearTouchStart(e)
                });
                date_dd.addEventListener('mousedown', function(event1) {
                    var e = event1 || window.event1;
                    document.onmousemove = function(event) {
                        gearTouchMove.call(date_dd,event)
                    }
                    gearTouchStart(e)
                });
                date_mm.addEventListener('mousedown', function(event1) {
                    var e = event1 || window.event1;
                    gearTouchStart(e);
                    document.onmousemove = function(event) {
                        gearTouchMove.call(date_mm,event)
                    }
                });
            }
            //初始化年月日插件默认值
            ...
            function popupYM(e) {
                ...
                lcalendar_finish.addEventListener('mousedown', finishMobileYM);
                var date_yy = _self.gearDate.querySelector(".date_yy");
                var date_mm = _self.gearDate.querySelector(".date_mm");
                date_yy.addEventListener('touchstart', gearTouchStart);
                date_mm.addEventListener('touchstart', gearTouchStart);
            ...
            function popupDateTime(e) {
                ...
                lcalendar_finish.addEventListener('mousedown', finishMobileDateTime);
                var date_yy = _self.gearDate.querySelector(".date_yy");
                var date_mm = _self.gearDate.querySelector(".date_mm");
                var date_dd = _self.gearDate.querySelector(".date_dd");
                ...
                time_hh.addEventListener('mousedown', function(event1) {
                    var e = event1 || window.event1;
                    document.onmousemove = function(event) {
                        gearTouchMove.call(time_hh,event)
                    }
                    gearTouchStart(e)
                });
                time_mm.addEventListener('mousedown', function(event1) {
                    var e = event1 || window.event1;
                    gearTouchStart(e);
                    document.onmousemove = function(event) {
                        gearTouchMove.call(time_mm,event)
                    }
                });
            }
            //初始化年月日时分插件默认值
            ...
            function popupTime(e) {
                ...
                lcalendar_finish.addEventListener('mousedown', finishMobileTime);
                var time_hh = _self.gearDate.querySelector(".time_hh");
                var time_mm = _self.gearDate.querySelector(".time_mm");
                time_hh.addEventListener('touchstart', gearTouchStart);
                time_mm.addEventListener('touchstart', gearTouchStart);
            ...
            function setTimeGearTooth() {
                if(!_self.gearDate.querySelectorAll(".time_hh").length > 0){
                    return
                }
                var time_hh = _self.gearDate.querySelector(".time_hh");
            ...
            function gearTouchStart(e) {
                ...
                target["old_" + target.id] = !!e.targetTouches ? e.targetTouches[0].screenY : e.screenY;
                ...
                document.onmouseup = function(event) {
                    ...
                    gearTouchEnd.call(target,event)
                }
            }
            //手指移动
            function gearTouchMove(e) {
                ...
                target["new_" + target.id] = !!e.targetTouches ? e.targetTouches[0].screenY : e.screenY;
                target["n_t_" + target.id] = (new Date()).getTime();
                var f = (target["new_" + target.id] - target["old_" + target.id]) * 30 / window.innerHeight;
                target["pos_" + target.id] = target["o_d_" + target.id] + f;
                target.style["-webkit-transform"] = 'translate3d(0,' + target["pos_" + target.id] + 'em,0)';
                target.setAttribute('top', target["pos_" + target.id] + 'em');
                if (target["new_" + target.id] < 1) {
                    gearTouchEnd(e);
                };
            }
            //离开屏幕
            ...
            function rollGear(target) {
                ...
                target["int_" + target.id] = setInterval(function() {
                    if(document.querySelector('.gearDate') === null) {
                        clearInterval(target["int_" + target.id]);
                    }
